...
import com.ibatis.tools.autogen.util.StringUtil;


/**
 * Function: jdbc数据库连接类.
 * @Date:2014-12-1上午10:54:39
 */
public class DbConn {
	/** 日志记录 */
	...
	private void init() {
		...
		try {
			if(settings.getDbType()==Settings.DB_TYPE_MYSQL){
				...
				.append("?autoReconnect=true&amp;characterEncoding="+charset+"&amp;zeroDateTimeBehavior=convertToNull&amp;transformedBitIsBoolean=true");
			}

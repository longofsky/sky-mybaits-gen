...
import com.ibatis.tools.autogen.util.CharUtil;

/**
 * Function: 封装元数据的一些信息.
 * @Date:2014-12-1上午10:39:33
 */
...
//		s = s.replaceAll("_", "");
	...
	public String toString() {
		return String.format("[colName:%s,colType:%s,colSQLType:%s,propertyName:%s,propertyType:%s]", colName,colType,colSQLType,propertyName,propertyType);
	}
}
